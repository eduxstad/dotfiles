...
return {
  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ["<Tab>"] = "<C-w>w",
        ["<M-3>"] = { '<Cmd>execute v:count . "ToggleTerm direction=float"<CR>', desc = "Toggle terminal" },
      },
      t = {
        ["<M-3>"] = { "<Cmd>ToggleTerm diretion=float<CR>", desc = "Toggle terminal" },
      },
      i = {
        ["<M-3>"] = { "<Esc><Cmd>ToggleTerm diretion=float<CR>", desc = "Toggle terminal" },
      },
    },
  options = {
      opt = {
